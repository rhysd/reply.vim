...
command! -nargs=0 -bar ReplRecv call reply#command#recv()
command! -nargs=* -bang -range=0 -complete=customlist,reply#command#completion_start ReplAuto call reply#command#auto([<f-args>], <bang>0, <count> != 0, <line1>, <line2>)
